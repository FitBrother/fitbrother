...
--
-- Extraído com `docker exec supabase_db_fitbrother pg_dump -U postgres
-- --schema-only --schema=auth --schema=storage --schema=_realtime
-- --schema=realtime --schema=extensions --schema=graphql
-- --schema=graphql_public --schema=vault postgres` do Postgres LOCAL deste
-- projeto — reflete exatamente a versão do Supabase CLI pinada aqui
-- (supabase/config.toml major_version=17), não um dump genérico da internet.
--
-- Rode DEPOIS de bootstrap/00-extensions.sql e bootstrap/01-roles.sql, com
-- `psql` (usa \restrict/\unrestrict, meta-comando do psql 17 — não é SQL
-- padrão). Referências a `net.*` (pg_net) aparecem só dentro do corpo de um
-- event trigger condicional — não quebram o load mesmo sem pg_net instalado.

\restrict r0cUsW8fcN34F8FVFViYaXVoS69WXlFUsrg2Ii1ti46OtKvWiFY2KnaqW5S3CIN
...
--
-- Name: messages_2026_08_30; Type: TABLE; Schema: realtime; Owner: supabase_admin
--
...
ALTER TABLE realtime.messages_2026_08_30 OWNER TO supabase_admin;

--
-- Name: messages_2026_08_31; Type: TABLE; Schema: realtime; Owner: supabase_admin
--
...
ALTER TABLE realtime.messages_2026_08_31 OWNER TO supabase_admin;

--
-- Name: messages_2026_09_01; Type: TABLE; Schema: realtime; Owner: supabase_admin
--
...
ALTER TABLE realtime.messages_2026_09_01 OWNER TO supabase_admin;
...
--
-- Name: messages_2026_08_30; Type: TABLE ATTACH; Schema: realtime; Owner: supabase_admin
--
...
--
-- Name: messages_2026_08_31; Type: TABLE ATTACH; Schema: realtime; Owner: supabase_admin
--
...
--
-- Name: messages_2026_09_01; Type: TABLE ATTACH; Schema: realtime; Owner: supabase_admin
--
...
--
-- Name: messages_2026_08_30 messages_2026_08_30_pkey; Type: CONSTRAINT; Schema: realtime; Owner: supabase_admin
--
...
--
-- Name: messages_2026_08_31 messages_2026_08_31_pkey; Type: CONSTRAINT; Schema: realtime; Owner: supabase_admin
--
...
--
-- Name: messages_2026_09_01 messages_2026_09_01_pkey; Type: CONSTRAINT; Schema: realtime; Owner: supabase_admin
--
...
--
-- Name: messages_2026_08_30_inserted_at_topic_idx; Type: INDEX; Schema: realtime; Owner: supabase_admin
--
...
--
-- Name: messages_2026_08_31_inserted_at_topic_idx; Type: INDEX; Schema: realtime; Owner: supabase_admin
--
...
--
-- Name: messages_2026_09_01_inserted_at_topic_idx; Type: INDEX; Schema: realtime; Owner: supabase_admin
--
...
--
-- Name: objects meal_audios_owner_delete; Type: POLICY; Schema: storage; Owner: supabase_storage_admin
--

CREATE POLICY meal_audios_owner_delete ON storage.objects FOR DELETE TO authenticated USING (((bucket_id = 'meal-audios'::text) AND ((auth.uid())::text = (storage.foldername(name))[1])));


--
-- Name: objects meal_audios_owner_insert; Type: POLICY; Schema: storage; Owner: supabase_storage_admin
--

CREATE POLICY meal_audios_owner_insert ON storage.objects FOR INSERT TO authenticated WITH CHECK (((bucket_id = 'meal-audios'::text) AND ((auth.uid())::text = (storage.foldername(name))[1])));


--
-- Name: objects meal_audios_owner_select; Type: POLICY; Schema: storage; Owner: supabase_storage_admin
--

CREATE POLICY meal_audios_owner_select ON storage.objects FOR SELECT TO authenticated USING (((bucket_id = 'meal-audios'::text) AND ((auth.uid())::text = (storage.foldername(name))[1])));


--
-- Name: objects meal_audios_owner_update; Type: POLICY; Schema: storage; Owner: supabase_storage_admin
--

CREATE POLICY meal_audios_owner_update ON storage.objects FOR UPDATE TO authenticated USING (((bucket_id = 'meal-audios'::text) AND ((auth.uid())::text = (storage.foldername(name))[1]))) WITH CHECK (((bucket_id = 'meal-audios'::text) AND ((auth.uid())::text = (storage.foldername(name))[1])));
...
--
-- Name: objects post_images_owner_delete; Type: POLICY; Schema: storage; Owner: supabase_storage_admin
--

CREATE POLICY post_images_owner_delete ON storage.objects FOR DELETE TO authenticated USING (((bucket_id = 'post-images'::text) AND ((auth.uid())::text = (storage.foldername(name))[1])));


--
-- Name: objects post_images_owner_insert; Type: POLICY; Schema: storage; Owner: supabase_storage_admin
--

CREATE POLICY post_images_owner_insert ON storage.objects FOR INSERT TO authenticated WITH CHECK (((bucket_id = 'post-images'::text) AND ((auth.uid())::text = (storage.foldername(name))[1])));


--
-- Name: objects post_images_owner_select; Type: POLICY; Schema: storage; Owner: supabase_storage_admin
--

CREATE POLICY post_images_owner_select ON storage.objects FOR SELECT TO authenticated USING (((bucket_id = 'post-images'::text) AND ((auth.uid())::text = (storage.foldername(name))[1])));


--
-- Name: objects post_images_owner_update; Type: POLICY; Schema: storage; Owner: supabase_storage_admin
--

CREATE POLICY post_images_owner_update ON storage.objects FOR UPDATE TO authenticated USING (((bucket_id = 'post-images'::text) AND ((auth.uid())::text = (storage.foldername(name))[1]))) WITH CHECK (((bucket_id = 'post-images'::text) AND ((auth.uid())::text = (storage.foldername(name))[1])));
...
--
-- Name: TABLE messages_2026_08_30; Type: ACL; Schema: realtime; Owner: supabase_admin
--
...
--
-- Name: TABLE messages_2026_08_31; Type: ACL; Schema: realtime; Owner: supabase_admin
--
...
--
-- Name: TABLE messages_2026_09_01; Type: ACL; Schema: realtime; Owner: supabase_admin
--
...
\unrestrict r0cUsW8fcN34F8FVFViYaXVoS69WXlFUsrg2Ii1ti46OtKvWiFY2KnaqW5S3CIN
