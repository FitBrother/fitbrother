...
export function InstallPrompt() {
  ...
  const guide =
    install.status === "installable-mac-safari"
      ? {
          title: "Adicionar ao Dock",
          subtitle: "Acesse o Fitbrother direto do Dock do seu Mac.",
          step1: "1. Clique no ícone de Compartilhar na barra de endereço",
          step2: "2. Escolha “Adicionar ao Dock”",
        }
      : {
          title: "Adicionar à Tela de Início",
          subtitle: "Acesse o Fitbrother direto da tela inicial do seu celular.",
          step1: "1. Toque no ícone de Compartilhar do seu navegador",
          step2: "2. Toque em “Adicionar à Tela de Início”",
        };
  ...
  return (
    <>
      ...
      >
        <View className="flex-1 pr-3">
          <Text className="font-sans-medium text-base text-neutral-800">{guide.title}</Text>
          <Text className="font-sans text-sm text-neutral-500">{guide.subtitle}</Text>
        </View>
        ...
        <View className="flex-1 items-center justify-center bg-black/40 px-6">
          <View className="w-full max-w-sm gap-4 rounded-2xl bg-white p-6">
            <View className="flex-row items-start justify-between">
              <Text className="flex-1 font-sans-bold text-lg text-neutral-800">{guide.title}</Text>
              <Pressable
